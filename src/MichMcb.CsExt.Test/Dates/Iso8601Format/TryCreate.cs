namespace MichMcb.CsExt.Test.Dates.Iso8601Format
{
	...
	public static class TryCreate
	{
		...
		public static void CorrectLengths()
		{
			...
			Helper.CheckValid("yyyy-MM-ddTHH:mm:ssZ".Length, Iso8601Parts.Format_ExtendedFormat_NoMillis_UtcTz);
			Helper.CheckValid("yyyy-MM-ddTHH:mm:ss+00:00".Length, Iso8601Parts.Format_ExtendedFormat_NoMillis_FullTz);
			Helper.CheckValid("yyyy-MM-ddTHH:mm:ss".Length, Iso8601Parts.Format_ExtendedFormat_NoMillis_LocalTz);
			...
			Helper.CheckValid("yyyyMMddTHHmmssZ".Length, Iso8601Parts.Format_BasicFormat_NoMillis_UtcTz);
			Helper.CheckValid("yyyyMMddTHHmmss+0000".Length, Iso8601Parts.Format_BasicFormat_NoMillis_FullTz);
			Helper.CheckValid("yyyyMMddTHHmmss".Length, Iso8601Parts.Format_BasicFormat_NoMillis_LocalTz);
			...
			Helper.CheckValid("yyyydddTHHmmss.sss".Length, Iso8601Parts.YearDay | Iso8601Parts.HourMinuteSecondMillis);
			...
			Helper.CheckValid("yyyy-dddTHHmmss.sss".Length, Iso8601Parts.Separator_Date | Iso8601Parts.YearDay | Iso8601Parts.HourMinuteSecondMillis);
			...
			Helper.CheckValid("yyyy-dddTHH:mm:ss.sss".Length, Iso8601Parts.Separator_All | Iso8601Parts.YearDay | Iso8601Parts.HourMinuteSecondMillis);
			...
			Helper.CheckValid("yyyyMMddTHHmmss.sss".Length, Iso8601Parts.YearMonthDay | Iso8601Parts.HourMinuteSecondMillis);
			...
			Helper.CheckValid("yyyy-MM-ddTHHmmss.sss".Length, Iso8601Parts.Separator_Date | Iso8601Parts.YearMonthDay | Iso8601Parts.HourMinuteSecondMillis);
			...
			Helper.CheckValid("yyyy-MM-ddTHH:mm:ss.sss".Length, Iso8601Parts.Separator_All | Iso8601Parts.YearMonthDay | Iso8601Parts.HourMinuteSecondMillis);
			...
			Helper.CheckValid("THHmmss.sss".Length, Iso8601Parts.HourMinuteSecondMillis);
			...
			Helper.CheckValid("THHmmss.sssZ".Length, Iso8601Parts.HourMinuteSecondMillis | Iso8601Parts.Tz_Utc);
			...
			Helper.CheckValid("THHmmss.sss+00".Length, Iso8601Parts.HourMinuteSecondMillis | Iso8601Parts.Tz_Hour);
			...
			Helper.CheckValid("THHmmss.sss+0000".Length, Iso8601Parts.HourMinuteSecondMillis | Iso8601Parts.Tz_HourMinute);
			...
			Helper.CheckValid("THH:mm:ss.sss".Length, Iso8601Parts.Separator_Time | Iso8601Parts.HourMinuteSecondMillis);
			...
			Helper.CheckValid("THH:mm:ss.sssZ".Length, Iso8601Parts.Separator_Time | Iso8601Parts.HourMinuteSecondMillis | Iso8601Parts.Tz_Utc);
			...
			Helper.CheckValid("THH:mm:ss.sss+00".Length, Iso8601Parts.Separator_Time | Iso8601Parts.HourMinuteSecondMillis | Iso8601Parts.Tz_Hour);
			...
			Helper.CheckValid("THH:mm:ss.sss+0000".Length, Iso8601Parts.Separator_Time | Iso8601Parts.HourMinuteSecondMillis | Iso8601Parts.Tz_HourMinute);
			...
			Helper.CheckValid("THHmmss.sss+00:00".Length, Iso8601Parts.Separator_Tz | Iso8601Parts.HourMinuteSecondMillis | Iso8601Parts.Tz_HourMinute);
			...
			Helper.CheckValid("THH:mm:ss.sss+00:00".Length, Iso8601Parts.Separator_Tz | Iso8601Parts.Separator_Time | Iso8601Parts.HourMinuteSecondMillis | Iso8601Parts.Tz_HourMinute);
		}
		[Fact]
		public static void BadFormats()
		{
			Helper.CheckInvalid("Nothing was provided for the format", Iso8601Parts.None);
			...
			Helper.CheckInvalid("The provided format for the time portion is not valid", Iso8601Parts.Minute | Iso8601Parts.Second | Iso8601Parts.Millis);
			...
			Helper.CheckInvalid("The provided format for the time portion is not valid", Iso8601Parts.Second | Iso8601Parts.Millis);
			Helper.CheckInvalid("The provided format for the time portion is not valid", Iso8601Parts.Second);
			Helper.CheckInvalid("The provided format for the time portion is not valid", Iso8601Parts.Millis);
